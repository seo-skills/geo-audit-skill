...
def known_keys() -> set[str]:
    ...
    for parent, children in {
        ...
        "scan": ["brand", "site", "platforms", "platforms_checked", "platforms_total",
                 "total_results", "manual_checks", "same_as", "assistants"],
        "assistants": ["asked", "reason", "provider", "locale", "requested", "brand", "site",
                       "category", "category_source", "credits_used", "credits_remaining",
                       "engines"],
        "engines": ["engine", "label", "model", "brand_question", "category_question"],
        "brand_question": ["status", "question", "reason", "recognized", "category", "offers",
                           "description", "competitors", "cited", "searched", "http_status",
                           "credits", "observed_at"],
        "category_question": ["status", "question", "reason", "named", "position", "ranked",
                              "named_outside_list", "listed", "cited", "searched",
                              "search_queries", "http_status", "credits", "observed_at"],
