...
Expected: `seomator-geo-audit 1.2.x` or newer.
...
- **Older than 1.2.0** -> stop and say: "This skill needs seomator-geo-audit 1.2.0 or newer. Upgrade with `uv tool upgrade seomator-geo-audit`."
