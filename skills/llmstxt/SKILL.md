...
Expected: `seomator-geo-audit 0.7.x` or newer.
...
- **Older than 0.7.0** -> stop and say: "This skill needs seomator-geo-audit 0.7.0 or newer. Upgrade with `uv tool upgrade seomator-geo-audit`."
